...
public class ApplicationProperties {
	...
	public static final String PROPERTY_APP_CUSTOM_PERMISSIONS_ENABLED = "app.custom.permissions.enabled";
	public static final String PROPERTY_APP_CUSTOM_ROLES_ENABLED = "app.custom.roles.enabled";
	...
	private static final List<String> SUPPORTED_KEYS = List.of(PROPERTY_APP_NAME, PROPERTY_APP_VERSION,
			PROPERTY_APP_CLI_THEME, PROPERTY_APP_CLI_ENABLED, PROPERTY_APP_CLI_DISPLAY_PROMPT,
			PROPERTY_APP_TRANSACTION_LOG_ENABLED, PROPERTY_APP_TRANSACTION_LOG_PATH,
			PROPERTY_APP_TRANSACTION_LOG_INCLUDE_DATABASE, PROPERTY_DATABASE_ENABLED, PROPERTY_DATABASE_TYPE,
			PROPERTY_DATABASE_USERNAME, PROPERTY_DATABASE_PASSWORD, PROPERTY_DATABASE_PORT, PROPERTY_DATABASE_VENDOR,
			PROPERTY_DATABASE_NAME, PROPERTY_DATABASE_HOST, PROPERTY_DATABASE_DDL_MODE, PROPERTY_ARGON2_MEMORY_SIZE,
			PROPERTY_ARGON2_ITERATIONS, PROPERTY_ARGON2_PARALLELISM, PROPERTY_ARGON2_SALT_LENGTH,
			PROPERTY_ARGON2_HASH_LENGTH, PROPERTY_JWT_ALGORITHM, PROPERTY_JWT_ISSUER, PROPERTY_JWT_REFRESH_EXPIRATION,
			PROPERTY_JWT_ACCESS_EXPIRATION, PROPERTY_JWT_SECRET, PROPERTY_JWT_PRIVATE_KEY_PATH,
			PROPERTY_JWT_PUBLIC_KEY_PATH, PROPERTY_AES_TRANSFORMATION, PROPERTY_AES_KEY_SIZE, PROPERTY_AES_TAG_LENGTH,
			PROPERTY_AES_IV_LENGTH, PROPERTY_SALT_KEY_ITERATIONS, PROPERTY_SALT_KEY_LENGTH, PROPERTY_OAUTH2_TOKEN_URL,
			PROPERTY_OAUTH2_CLIENT_SECRET, PROPERTY_OAUTH2_AUTHORIZE_URL, PROPERTY_OAUTH2_USER_URL,
			PROPERTY_OAUTH2_DEVICE_CODE_URL, PROPERTY_OAUTH2_SCOPES, PROPERTY_OAUTH2_TOKEN_PARAMTERS,
			PROPERTY_DATABASE_SQL_SHOW, PROPERTY_DATABASE_SQL_FORMAT, PROPERTY_ALLOW_ONLY_ADMIN_TO_CREATE_TEAM);

	private static final Set<String> SENSITIVE_KEYS = Set.of(PROPERTY_DATABASE_PASSWORD, PROPERTY_OAUTH2_CLIENT_ID,
