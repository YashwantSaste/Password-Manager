package com.project.password.manager.database.postgres.hibernate.bootstrap;
...
import com.project.password.manager.database.postgres.hibernate.entity.HibernateEntityProvider;
...
public final class HibernateBootStrap {
	...
	private static Map<String, Object> hibernateConfiguration(@NotNull IDatabaseConfiguration databaseConfiguration) {
		...
		config.put(Environment.FORMAT_SQL, "false");
